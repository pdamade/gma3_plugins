...
### Usage
THE FOLLOWING ASSUMES YOU HAVE AN OSC HOST IN YOUR NETWORK RUNNING CHATAIGNE AND CONNECTED VIA RS232 TO THE PROJECTOR.
...
Download the `.noisette` file and run it in Chataigne on your OSC host. 
